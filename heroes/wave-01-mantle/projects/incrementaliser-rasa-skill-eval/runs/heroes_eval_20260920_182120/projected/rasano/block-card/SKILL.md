---
name: block-card
description: 'Block or freeze a bank card that is lost, stolen, damaged, expired,
  or temporarily unused while traveling. Activate for card block, freeze, lost card,
  stolen card, or fraud on a card.
