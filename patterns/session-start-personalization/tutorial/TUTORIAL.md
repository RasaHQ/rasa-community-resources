...
```bash
# 1. the pin
rasa-pro==3.19.0.dev5  →  rasa-pro==3.20.0.dev6   # rasa-version-ignore: upgrade path
...
">=3.10,…"`, `uv lock --prerelease=allow` fails with an unhelpful resolver error until you raise it.
