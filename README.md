...
Verified with: rasa-pro 3.20.0.dev20260916190743, Python 3.11+, uv
...
Override the target with `make migrate VERSION=3.20.0.dev20260916190743`, preview it first with
`make migrate-dry VERSION=3.20.0.dev20260916190743`, or jump to the newest stable release with
