...
Verified with: rasa-pro 3.20.0rc1, Python 3.11+, uv
...
Override the target with `make migrate VERSION=3.20.0rc1`, preview it first with
`make migrate-dry VERSION=3.20.0rc1`, or jump to the newest stable release with
