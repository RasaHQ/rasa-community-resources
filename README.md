...
Verified with: rasa-pro 3.20.0, Python 3.11+, uv
...
Override the target with `make migrate VERSION=3.20.0`, preview it first with
`make migrate-dry VERSION=3.20.0`, or jump to the newest stable release with
