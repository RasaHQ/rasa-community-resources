...
Verified with: rasa-pro 3.21.0.dev1, Python 3.11+, uv
...
Override the target with `make migrate VERSION=3.21.0.dev1`, preview it first with
`make migrate-dry VERSION=3.21.0.dev1`, or jump to the newest stable release with
