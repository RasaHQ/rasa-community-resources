# Autono — Voice Car Purchasing with Rasa Mantle
...
A production-style **voice car-purchase agent** built with the new Rasa **Skills / Mantle** architecture and **Deepgram** for speech-to-text and text-to-speech.
...
> Suggested public repository name: **`rasa-mantle-voice-car-purchase-skills`**
...
One directory per Mantle skill. Each skill encapsulates the instructions and controls for a specific capability.
...
This lets capabilities remain independently understandable and reusable while Mantle coordinates them into a larger customer journey.
...
* the build sequence
* explanation of each Mantle concept
* commands to run
* test conversations
* paste-ready code
* checkpoints
